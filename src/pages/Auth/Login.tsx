...
const LOGIN_IMAGES = [
  ...
  '/login-img/13.jpg',
  '/login-img/14.jpg',
  // '/login-img/resized-eugene-golovesov-6mV2lNqyLps-unsplash.jpg',
  // '/login-img/resized-eugene-golovesov-6qbx0lzGPyc-unsplash.jpg',
  // '/login-img/resized-eugene-golovesov-7WBsLbfI-u8-unsplash.jpg',
  // '/login-img/resized-eugene-golovesov-7xbuKKKAufc-unsplash.jpg',
  // '/login-img/resized-eugene-golovesov-caihSqoTSiM-unsplash.jpg',
  // '/login-img/resized-eugene-golovesov-cTChGLob-2k-unsplash.jpg',
  // '/login-img/resized-eugene-golovesov-HjiqtsaapcQ-unsplash.jpg',
  // '/login-img/resized-eugene-golovesov-S3XiypCkad8-unsplash.jpg',
  // '/login-img/resized-eugene-golovesov-TESBqXfVrUI-unsplash.jpg',
  // '/login-img/resized-eugene-golovesov-TzJX6uuuEe8-unsplash.jpg',
  // '/login-img/resized-eugene-golovesov-VdQigv27QgY-unsplash.jpg',
  // '/login-img/resized-eugene-golovesov-vmFpmjU6GWI-unsplash.jpg',
  // '/login-img/resized-eugene-golovesov-WQxD_GRgn74-unsplash.jpg',
  // '/login-img/resized-eugene-golovesov-_KkVtwGLV8A-unsplash.jpg',
  // '/login-img/Frame_1_11zon.webp',
  // '/login-img/Introducing_OpenAI_Japan_7_11zon.webp',
  // '/login-img/Leadership_1.1_5_11zon.webp',
  // '/login-img/NextGenAI_1x1-1_6_11zon.webp',
  // '/login-img/OAI_Forge_1x1_4_11zon.webp',
  // '/login-img/oai_GA_Stories_1.1_3_11zon.webp',
  // '/login-img/our-agreement-with-the-pentagon-1-1.webp',
